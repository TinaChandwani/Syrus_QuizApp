...
<div class="row">
<div class="col-lg-6">
<span class="logo">Quiz-ify</span></div>
...
<!-- <div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex. BE/10XXX/YY)" class="form-control input-md" type="text" value="
...
// echo isset($_GET['gender']) ? $_GET['gender'] :'';
...
if (!isset($_GET['branch']))
 ...
 ?>>Select Branch</option>
  ...
  echo isset($_GET['branch']) ? $_GET['branch'] :'';
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" placeholder="Enter your TeamName" class="form-control input-md" type="username" value="<?php
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Quiz-ify</a></div>
</div>
