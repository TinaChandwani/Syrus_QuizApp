...
?>
<?php
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['6e447159425d2d']) && isset($_SESSION['6e447159425d2d']) == "6e447159425d2d" && isset($_GET['endquiz']) == 'end') {
...
function end(){
  ...
  if(data=="yes"){
    window.location ="account.php?q=quiz&step=2&eid=' . isset($_GET['eid']) . '&n=' . isset($_GET['n']) . '&t=' . isset($_GET['total']) . '&endquiz=end";
  }
}
function enable(){
...
<br />';
            ...
            if ($_GET['t'] > $_GET['n'] && $_GET['n'] != 1) {
                echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Lock</font></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
            } else if ($_GET['t'] == $_GET['n']) {
                echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Lock</font></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</form><br><br>';
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            ...
            while ($row = mysqli_fetch_array($q12)) {
                $name     = isset($row['name']);
                $branch   = isset($row['branch']);
                $username = isset($row['username']);
            }
            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . isset($c) . '</b></td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . isset($branch) . '</td><td style="vertical-align:middle">' . isset($username) . '</td><td style="vertical-align:middle">' . isset($s) . '</td><td style="vertical-align:middle">';
        }
    }
    else{
    }
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Edufying<br><br></span></div>
